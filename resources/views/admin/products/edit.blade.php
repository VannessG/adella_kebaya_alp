...
<div class="container pb-4">
    <div class="row align-items-end">
        <div class="col-md-8 text-center text-md-start">
            <h1 class="display-5 fw-normal text-uppercase text-black mb-2" style="font-family: 'Marcellus', serif; letter-spacing: 0.1em;">Edit Produk</h1>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control rounded-0 bg-subtle border-0 p-3 @error('rent_price_per_day') is-invalid @enderror" 
                                       id="rent_price_per_day" name="rent_price_per_day" value="{{ old('rent_price_per_day', $product->rent_price_per_day) }}">
                            </div>
