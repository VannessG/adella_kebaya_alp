...
<div class="container pb-4">
    <div class="row align-items-end">
        <div class="col-12 col-md-8 text-center text-md-start mb-3 mb-md-0">
            <h1 class="display-5 fw-normal text-uppercase text-black mb-2 font-serif h3">Tambah Produk</h1>
            ...
            <div class="card border rounded-0 bg-white p-4 p-md-5 shadow-sm" style="border-color: var(--border-color);">
                ...
                <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control rounded-0 bg-subtle border-0 p-3 @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" required placeholder="Masukkan nama produk">
                        @error('name')
                    ...
                    <div class="row g-4 mb-4">
                        <div class="col-12 col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control rounded-0 bg-subtle border-0 p-3 @error('price') is-invalid @enderror" id="price" name="price" value="{{ old('price') }}" min="0" required placeholder="0">
                            </div>
                            @error('price')
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="input-group">
                                <span class="input-group-text rounded-0 bg-white border-end-0 text-muted small" style="border-color: #eee;">Rp</span>
                                <input type="number" class="form-control rounded-0 bg-subtle border-0 p-3 @error('rent_price_per_day') is-invalid @enderror" id="rent_price_per_day" name="rent_price_per_day" value="{{ old('rent_price_per_day') }}" min="0" placeholder="0">
                            </div>
                    ...
                    <div class="row g-4 mb-4">
                        <div class="col-12 col-md-6">
                            ...
                            <input type="number" class="form-control rounded-0 bg-subtle border-0 p-3 @error('stock') is-invalid @enderror" id="stock" name="stock" value="{{ old('stock') }}" min="0" required placeholder="0">
                        </div>
                        <div class="col-12 col-md-6">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control rounded-0 bg-subtle border-0 p-3 @error('description') is-invalid @enderror" id="description" name="description" rows="4" required placeholder="Jelaskan detail produk...">{{ old('description') }}</textarea>
                    </div>
