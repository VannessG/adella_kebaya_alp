...
<div class="container pb-4">
    <div class="row align-items-end">
        <div class="col-md-8 text-center text-md-start">
            <h1 class="display-5 fw-normal text-uppercase text-black mb-2" style="font-family: 'Marcellus', serif; letter-spacing: 0.1em;">Rekap Absensi</h1>
                    ...
                    <tbody>
                        @forelse($shifts as $shift)
                            <tr style="border-bottom: 1px solid #f0f0f0;">
                                ...
                                <td class="py-3">
                                    <span class="badge rounded-0 border text-black bg-white px-2 py-1 text-uppercase" style="font-size: 0.6rem; letter-spacing: 0.05em; border-color: #ddd;">
                                        {{ $shift->branch->name }}
                                    </span>
                                </td>
                                <td class="py-3 text-muted small text-uppercase">{{ $shift->view_time }}</td>
                                <td class="py-3 text-center text-black small">{{ $shift->view_total_staff }}</td>
                                ...
                                <td class="pe-4 py-3 text-end">
                                    <a href="{{ route('admin.shifts.show', $shift->id) }}" class="btn btn-outline-dark rounded-0 px-3 py-1 text-uppercase fw-bold" style="font-size: 0.65rem; letter-spacing: 0.05em;">Detail</a>
                                </td>
                            </tr>
                        @empty
                            <tr>
