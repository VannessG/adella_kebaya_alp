...
<div class="container pb-4">
    <div class="row align-items-end">
        <div class="col-12 col-md-8 text-center text-md-start mb-3 mb-md-0">
            <h1 class="display-5 fw-normal text-uppercase text-black mb-2 font-serif h3">Tambah Diskon</h1>
            ...
            <div class="card border rounded-0 bg-white p-4 p-md-5 shadow-sm" style="border-color: var(--border-color);">
                ...
                <form action="{{ route('admin.discounts.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control rounded-0 bg-subtle border-0 p-3 @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" required placeholder="Contoh: Promo Akhir Tahun">
                        @error('name')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control rounded-0 bg-subtle border-0 p-3 @error('code') is-invalid @enderror" id="code" name="code" value="{{ old('code') }}" placeholder="Contoh: SALE2024">
                    ...
                    <div class="row g-4 mb-4">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="number" class="form-control rounded-0 bg-subtle border-0 p-3 @error('amount') is-invalid @enderror" id="amount" name="amount" value="{{ old('amount') }}" min="0" step="0.01" required placeholder="0">
                            <div class="form-text small text-muted mt-1" id="amountHelp" style="font-size: 0.75rem;">Masukkan nilai diskon</div>
                            @error('amount')
                                <div class="invalid-feedback small">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" class="form-control rounded-0 bg-subtle border-0 p-3 @error('max_usage') is-invalid @enderror" id="max_usage" name="max_usage" value="{{ old('max_usage') }}" min="1" placeholder="Tidak Terbatas">
                    ...
                    <div class="row g-4 mb-5">
                        <div class="col-12 col-md-6">
                            ...
                            <input type="date" class="form-control rounded-0 bg-subtle border-0 p-3 @error('start_date') is-invalid @enderror" id="start_date" name="start_date" value="{{ old('start_date') }}" required>
                            @error('start_date')
                                <div class="invalid-feedback small">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-12 col-md-6">
                            ...
                            <input type="date" class="form-control rounded-0 bg-subtle border-0 p-3 @error('end_date') is-invalid @enderror" id="end_date" name="end_date" value="{{ old('end_date') }}" required>
                            @error('end_date')
                                <div class="invalid-feedback small">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-5 p-3 border bg-subtle d-flex align-items-center" style="border-color: #eee !important;">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input rounded-0 border-black" id="is_active" name="is_active" value="1" checked>
                    ...
                    <div class="d-flex flex-column flex-md-row gap-3 pt-2">
                        <button type="submit" class="btn btn-primary-custom rounded-0 px-4 py-3 text-uppercase fw-bold w-100 w-md-auto" style="font-size: 0.8rem; letter-spacing: 0.1em;">Simpan Diskon</button>
